...
After entering the email and password, you will be asked to enter a **One-Time Password (OTP)** generated by the Authenticator App. To use **email verification** instead, click **“Try another method”** and select the Email option. 
